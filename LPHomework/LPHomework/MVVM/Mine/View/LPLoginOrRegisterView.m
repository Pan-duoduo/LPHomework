...
- (void)createUI {
    ...
    [self.acountTF mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    self.loginButton.titleLabel.font = LPFontBoldSize(24);
    self.loginButton.backgroundColor = [UIColor redColor];
    [self.loginButton setTitle:@"登录" forState:UIControlStateNormal];
//    [self.loginButton addTarget:self action:@selector(gogo) forControlEvents:UIControlEventTouchUpInside];
